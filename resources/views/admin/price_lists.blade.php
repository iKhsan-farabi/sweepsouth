...
@section('main-content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Daftar Jasa</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="barang">Pilihan Layanan</label>
                                            <div class="row">
                                                <div class="col-8">
                                        ...
                                        <div class="form-group">
                                            <label for="servis">Jenis Tempat</label>
                                            <div class="row">
                                                <div class="col-8">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <label for="harga-modal">Tarif</label>
                            ...
                            <hr>
                            <h5 class="mt-3">Daftar Jasa</h5>
                            <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="kiloan-tab" data-toggle="tab" href="#kiloan"
                                        role="tab" aria-controls="kiloan" aria-selected="true">Cleaning</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="satuan-tab" data-toggle="tab" href="#satuan"
                                        role="tab" aria-controls="satuan" aria-selected="true">Lainya</a>
                                </li>
                            </ul>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="badge badge-warning btn-ubah-harga"
                                                            ...
                                                            data-target="#changePriceModal">Ubah Biaya</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="badge badge-warning btn-update-cost"
                                                        ...
                                                        data-target="#updateCostModal">Ubah Biaya</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
